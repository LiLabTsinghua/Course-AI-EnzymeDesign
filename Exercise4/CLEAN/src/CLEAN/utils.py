...
def retrive_esm1b_embedding(fasta_name):
    esm_script = "./extract.py"#esm/scripts/extract.py
    esm_out = "data/esm_data"
    # esm_type = "../../../../../esm/esm1b_t33_650M_UR50S.pt"#esm1b_t33_650M_UR50S
    esm_type = '/data/home/wuke/Project/esm/esm1b_t33_650M_UR50S.pt'
